...
public:
	...
	void DrawCircle(const CPoint& center, const double radius, uint32_t lineColor) override;
	void FillCircle(const CPoint& center, const double radius, uint32_t fillColor) override;
